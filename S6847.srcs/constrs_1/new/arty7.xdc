...
#set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { vclk }]; #IO_L19P_T3_35 Sch=jc[4]
...
##Pmod Header JD
#set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { agb }]; #IO_L21N_T3_DQS_35 Sch=jd[1] da0
